...
// Variables
const rootDomain = "indiostduio.online"; // Ganti dengan domain utama kalian
const serviceName = "winter-darkness-b09f"; // Ganti dengan nama workers kalian
const apiKey = "YKr5xWr6FZLxQcXWb9Uy8AYzwc_q6mxVzK4La4B7"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "bgstsekali8@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "1d495c45218445c3709f4c27bedb38a7"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "44c80d646a33fae6d36e34ad376cb44f"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/vegannhasa/Nautica/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "ips.txt";
...
export default {
  async fetch(request, env, ctx) {
    try {
      ...
      const targetReverseProxy = env.REVERSE_PROXY_TARGET || "sidney.olgenerator.meancendikia.com";
